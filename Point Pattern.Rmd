...
Following code contains several methods for evaluating the spatial distribution of a discrete point pattern, in this case coal mines within the Uinta coal region in western Colorado. Kernel density estimations, the quadrant counts of the coal mine point pattern was mapped. The Hopkins-Skellam and Clak Evans tests statisitcs measure the ranomness in the points and test for clustering.
...
library(sf)
library(spatstat)
boundary <- st_read('C:/CMF_Project/502ProjectData/uinta_buff_1500ft.shp')
shapefile <- st_read("C:/CMF_Project/502ProjectData/coal_mines_Uinta.shp")
```
